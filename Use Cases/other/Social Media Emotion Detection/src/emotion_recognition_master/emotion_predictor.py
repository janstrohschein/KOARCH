...
class EmotionPredictor:
    ...
    def _get_model(self):
        self._loaded_model_filename = 'emotion_recognition_master/models/{}{}-{}.h5'.format(
            'unison-' if self.use_unison_model else '', self.classification, self.setting,)
    ...
    def _get_char_mapping():
        with open('/src/emotion_recognition_master/models/allowed-chars.pkl', 'rb') as f:
