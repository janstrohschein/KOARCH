...
anger, disgust, fear, joy, sadness, surprise) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (status_id) DO NOTHING;"
...
for msg in new_c.consumer:
    ...
    try:
        ...
        print('Could not insert status', new_emo['status_id_str'], 'from', new_emo['author_id_str'])
