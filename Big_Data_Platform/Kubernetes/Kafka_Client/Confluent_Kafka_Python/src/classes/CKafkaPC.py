...
class Configurator:
    def read_config(self, config_path, config_section=None):
        pass
...
class KubeConfigurator(Configurator):
    def read_config(self, config_path, config_section=None):
        config_dict = {}
...
class KafkaPC:
    def __init__(self, config_path, config_section=None):
        ...
        if config_section is None:
            self.configurator = KubeConfigurator()
        else:
            self.configurator = LocalConfigurator()

        self.config = self.configurator.read_config(
